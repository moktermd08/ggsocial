...
export const AGENTS: AgentDef[] = [
  {
    ...
    does: [
      ...
      "Sends it for approval with the slot already booked",
    ],
    handsOff: [
      "Never approves or publishes: an approver signs off every post, as they would a person's",
      "Never touches a post a person wrote",
      "Leaves media to people; posts that need an image say so",
    ],
    activityCodes: ["D-01"],
    everyMinutes: 60,
    cadence: "Hourly",
